...
import com.sunayanpradhan.randomreels.Model.*
import com.sunayanpradhan.randomreels.R
import com.sunayanpradhan.randomreels.databinding.EditProfileDialogLayoutBinding
import com.sunayanpradhan.randomreels.databinding.ViewProfileDialogLayoutBinding
        ...
        holder.reelsComment.setOnClickListener {
            ...
            commentContent?.addTextChangedListener(object : TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    var title: String = commentContent.text.toString()
...
//                    downloadAndroid11(position,documentFile);
    ...
    fun downloadForLessThan11(position: Int) {
    ...
    fun downloadForLessThan11ForSharing(position: Int) {
