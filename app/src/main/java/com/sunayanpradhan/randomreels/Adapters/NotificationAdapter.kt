...
import com.sunayanpradhan.randomreels.Activities.ReelsViewActivity
...
class NotificationAdapter(var NotificationItems:ArrayList<NotificationModel>, var context: Context):RecyclerView.Adapter<NotificationAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        var timeAgo= TimeAgo.using(currentItem.notificationAt)
        ...
        holder.openNotification.setOnClickListener {
            ...
            when (type) {
                ...
                "like" -> {
                    ...
                    var intent = Intent(context, ReelsViewActivity::class.java)
        ...
        var checkOpen:Boolean=currentItem.checkOpen
