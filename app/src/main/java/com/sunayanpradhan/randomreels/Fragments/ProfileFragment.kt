...
import com.sunayanpradhan.deverse.io.Models.FollowModel
import com.sunayanpradhan.deverse.io.Models.FollowingModel
import com.sunayanpradhan.randomreels.Activities.LogInActivity
import com.sunayanpradhan.randomreels.Adapters.ReelsThumbnailAdapter
...
import com.sunayanpradhan.randomreels.Model.SavedModel
import com.sunayanpradhan.randomreels.R
import com.sunayanpradhan.randomreels.databinding.EditProfileDialogLayoutBinding
import com.sunayanpradhan.randomreels.databinding.FragmentProfileBinding
                            ...
                            FirebaseDatabase.getInstance().reference.child("Users").addListenerForSingleValueEvent(object : ValueEventListener{
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    for (dataSnapshot1 in snapshot.children){
                                        ...
                                        val pebFollowData:InformationModel?= dataSnapshot1.getValue(InformationModel::class.java)
                                        ...
                                        .addListenerForSingleValueEvent(object : ValueEventListener {
                                            override fun onDataChange(snapshot: DataSnapshot) {
                                                ...
                                                for (dataSnapshot2 in snapshot.children){
                                                    ...
                                                    var data2=dataSnapshot2.getValue(InformationModel::class.java)
                            ...
                            FirebaseDatabase.getInstance().reference.child("reels").addListenerForSingleValueEvent(object : ValueEventListener{
                                override fun onDataChange(snapshot: DataSnapshot) {
                                    ...
                                    for (dataSnapshot1 in snapshot.children){
                                        ...
                                        val pebSavedData:ReelsModel?= dataSnapshot1.getValue(ReelsModel::class.java)
