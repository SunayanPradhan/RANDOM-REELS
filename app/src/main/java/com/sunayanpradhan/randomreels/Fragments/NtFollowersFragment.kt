...
import com.sunayanpradhan.randomreels.databinding.FragmentNtFollowersBinding
            ...
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    for (dataSnapshot in snapshot.children) {
                        val notification: NotificationModel?= dataSnapshot.getValue(NotificationModel::class.java)
                        ...
                        .child(FirebaseAuth.getInstance().uid.toString()).addValueEventListener(object :ValueEventListener{
                            override fun onDataChange(snapshot: DataSnapshot) {
                                ...
                                for (dataSnapshot in snapshot.children){
                                    ...
                                    var data:NotificationModel?=dataSnapshot.getValue(NotificationModel::class.java)
