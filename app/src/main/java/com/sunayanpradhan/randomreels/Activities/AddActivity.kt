...
import com.sunayanpradhan.randomreels.databinding.ActivityAddBinding
import com.sunayanpradhan.randomreels.databinding.FragmentAddBinding
...
class AddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addUpload.setOnClickListener {
            ...
            var title:String=binding.addTitle.text.toString()
            ...
            if (videoUri==false){
                ...
                storageReference.putFile(uri).addOnSuccessListener{
                    ...
                    storageReference.downloadUrl.addOnSuccessListener { uri->
                        ...
                        var fire= FirebaseDatabase.getInstance().reference.child("reels").push()
